...
/**
 * Simulation of card game war. In the simulation, we use array circular list
 * queues and array stacks. The card game WarByArrays for two players.
 *
 * @author ITSC 2214
 * @version 1.0
 */
public class WarByArrays {
    ...
    public WarByArrays(boolean isShuffled) {
        ...
        //StackADT<Card> stack1 = new ArrayStack();
        //StackADT<Card> stack2 = new ArrayStack();
