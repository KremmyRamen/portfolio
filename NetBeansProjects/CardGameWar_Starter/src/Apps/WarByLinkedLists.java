...
/**
 * Simulation of card game war. In the simulation, we use linked list-based
 * implementation of queues and linked list-based implementation of stacks. The
 * card game War for two players.
 *
 * @author ITSC 2214
 * @version 1.0
 */
public class WarByLinkedLists {
     ...
     *
     * @param isShuffled flag to determine whether to randomly shuffle cards
     */
    ...
    public void playRound() {
        try {
            ...
            //stack1.push(hand1.first());
            //stack2.push(hand2.first());
    ...
    /**
     * Play a war over stack1 and stack2. If this ends the game because one
     * player runs out of cards, give the cards to the winning player and return
